  ...
  this.include = function(){
    return this.client({
      '/player/graph.js': function(){
        var $, SocialCalc, colorIndex, getBarColor, getDrawColor, UpdateGraphRangeProposal, GraphSetCells, DoGraph, GraphChanged, MinMaxChanged, GraphSave, GraphLoad, GraphVerticalBar, GraphHorizontalBar, MakePieChart, MakeLineChart, MakeScatterChart, scc, b1, b2, b3, b4, b5, selectedbg, unselectedbg, cursorbg, hightLightForegoundColour, selectedTextColor;
        ...
        unselectedbg = 'f8f9fa';
        cursorbg = '';
        hightLightForegoundColour = '212529';
        selectedTextColor = '1a73e8';
        ...
        scc.defaultHighlightTypeCursorStyle = '';
        return scc.defaultHighlightTypeRangeStyle = 'color:#000;backgroundColor:#' + selectedbg + ';border:1px solid #c2daff;';
      }
    });
  };
}).call(this);
