...
(function () {
  ...
  this.include = function () {
    ...
    this.get((ref$ = {}, ref$[BASEPATH + "/static/format-layout.js"] = function () {
      this.response.type('application/javascript');
      return this.response.sendfile(RealBin + "/static/format-layout.js");
    }, ref$));
    this.get((ref$ = {}, ref$[BASEPATH + "/static/edit-layout.js"] = function () {
      this.response.type('application/javascript');
      return this.response.sendfile(RealBin + "/static/edit-layout.js");
    }, ref$));
    this.get((ref$ = {}, ref$[BASEPATH + "/static/layout.css"] = function () {
      this.response.type('text/css');
      return this.response.sendfile(RealBin + "/static/layout.css");
    }, ref$));
